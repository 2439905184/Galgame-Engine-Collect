...
+ [开源地址](https://github.com/ishani-rgb/VNES-Raylib)
+ 描述：
  + 状态：开源
  + 产地：未知
  + 技术：C语言
...
+ [官网](http://www.le-mo.jp/lemo/products/LemoNovel/index.htm)
+ 描述：
  + 历史：起源于`flash actions`语言
  + 状态：是否开源未知
  + 使用授权：未知

### `pymo`引擎

+ [官网](http://pymo.github.io/index_real.html)
+ [开源地址](https://github.com/pymo/pymo)
+ 描述：

  + 百科资料：https://baike.baidu.com/item/PYMO%E5%BC%95%E6%93%8E/6103436
  + 底层技术：python+pygame
  + 特性：
...
+ 描述：
  + 是否开源：未知
  + 技术：action script(adobe flash)
  + 使用授权：未知
  + 开发者规模：个人开发者

### `Suika2`引擎

+ [开源地址](https://github.com/ktabata/suika2)
...
+ [开源地址](https://github.com/hsdk123/Soul-Engine)
+ 描述
  + 是否开源：开源
...
+ [官网](http://www.product.co.jp/reallivemax/)
+ 描述：
  + 产地：日本
  + 开发者：日本visual arts公司开发
  + 是否开源：闭源
  + 授权协议：不明
...
+ 描述：
  + 是否开源：闭源
  + 开发者信息：[pajams公司](http://www.pajamas.ne.jp/)
  + 私有，非公开可使用引擎

### Reitsuki引擎

+ [开源地址](https://github.com/kasuganosora/Reitsuki)
+ 描述：
  + 是否开源：开源
  + 技术：基于web技术
  + 开发者信息：个人开发者
...
+ 描述：
  + 开发者信息：开发了rpgmaker的日本公司
  + 是否开源：闭源，私有

### TyranoBuilder

+ [官网](https://www.nyu-media.com/)
+ [steam下载地址](https://store.steampowered.com/app/345370/TyranoBuilder_Visual_Novel_Studio/)
+ 描述：
  + 是否开源：闭源，私有
  + 标准版免费，但是缺少商业支持
...
+ 使用授权：SYSTEM-NNN几乎是免费软件。 它是免费使用的。 它可以自由分发。
  不用于商业目的的软件可以免费分发。
  你不需要征求许可就可以使用或分发你为此目的而创建的软件。 请将该软件用于免费软件、豆瓣软件等。
  你不需要在使用本软件的作品中包括我们的版权声明，但如果你需要，请包括以下版权声明。
  如果您这样做，请在版权声明中使用 "Bug Neko Soft"、"TINYAN "或 "TINYAN"。

我们也愿意出版一本包含SYSTEM-NNN的解释书（以及同时包含的游戏样本等）。
只要不涉及工作，我们可以自由地、免费地做这件事。 没有必要与我们联系或将出版物寄给我们。

关于用本系统开发的软件的商业使用，请与我们联系。

对于因使用本软件而造成的任何直接或间接损失，我们概不负责。
